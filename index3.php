...
<div id="App">
  ...
  <header id="Header">
    <div id="HeaderWrap"><a id="Logo" href="#"><svg class="icon" role="img" alt="" width="1em" height="1em" viewBox="0 0 50 50">
      ...
      <div id="SettingsMenu">
        <button type="button" id="SettingsBtn" class="btn "><svg class="icon" role="img" alt="" width="1em" height="1em" viewBox="0 0 50 50">
...
<span id="mySpan"></span>
    ...
    <section class="dict-intro">
      ...
      <p>Tangorin is an online Japanese-English dictionary with example sentences and many features to help you learn the Japanese language.</p>
      <p>Search with English and/or Japanese, kana, kanji, or rōmaji. Use wildcards: _ for one character, * for zero or more. Select a dictionary to see the full list of search options.</p>
      <p>&nbsp;</p>
</section>
  	...
  	<!-- Footer-->
  <footer id="Footer"><span>© Tangorin Japanese Dictionary</span> <span><a title="About Japanese Dictionary Tangorin" href="about.html">About</a> · <a href="donate.html">Donate</a> · <a href="privacy.html">Privacy Policy</a></span> <span>contact@tangorin.com</span> <span><a href="https://www.facebook.com/tangorin" target="_blank" class="social-icon"><svg class="icon" aria-label="Facebook" role="img" alt="Facebook" width="1em" height="1em" viewBox="0 0 50 50">
    <use xlink:href="#icon-facebook"></use>
    </svg></a> <a href="https://twitter.com/tangorin" target="_blank" class="social-icon"><svg class="icon" aria-label="Twitter" role="img" alt="Twitter" width="1em" height="1em" viewBox="0 0 50 50">
...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="SVGSprite" width="0px" height="0px" style="display:none;">
